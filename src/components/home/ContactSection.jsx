    ...
    <section id="contact" className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-[#141414]">
      ...
      <div className="hidden lg:block relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 right-20">
          <blockquote className="text-[20px] lg:text-[20px] italic text-white leading-relaxed mb-8 max-w-[460px]">
            "We don't sell services. We build advisory relationships — grounded in trust, delivered through expertise."
          </blockquote>
          <cite className="flex items-center gap-4 text-[15px] font-medium tracking-widest uppercase text-[#C4973B] not-italic">
      ...
      <div className="flex flex-col justify-center px-6 py-24 lg:px-20 relative">
        <div ref={addToRefs} className="flex items-center gap-3 text-[15px] font-medium tracking-[0.24em] uppercase text-[#C4973B]/80 mb-6 opacity-0 translate-y-10 transition-all duration-700">
        ...
        <p ref={addToRefs} className="text-[14px] font-light leading-relaxed text-white max-w-[450px] mb-12 opacity-0 translate-y-10 transition-all duration-700 delay-200">
        ...
        <div className="space-y-2 mb-16 max-w-[500px]">
          {[
            ...
            >
              <div className="text-[12px] font-medium tracking-widest uppercase text-[#C4973B] w-24 shrink-0">{item.label}</div>
              <div className="text-[15px] font-light text-white leading-tight">
