...
const HomeInsightsV3 = () => {
  ...
  const insights = [
    ...
    { id: 11, category: 'assurance', categoryName: 'Assurance', tagClass: 'bg-orange-50 text-orange-600', date: 'Apr 2026', img: '/reportimg/from-tradition.avif', title: 'From Traditional to Agile: Internal Audit\'s New Mandate in India\'s Regulatory Environment', text: 'Boards demand real-time risk intelligence. Static annual audit plans are giving way to continuous, risk-responsive assurance frameworks.', readTime: '5 min' },
