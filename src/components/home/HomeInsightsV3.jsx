...
const HomeInsightsV3 = () => {
  ...
  const insights = [
    ...
    { id: 5, link: '/insights/income-tax-act-2025', category: 'taxation', categoryName: 'Taxation', tagClass: 'bg-green-50 text-green-600', date: 'Apr 2026', img: 'https://picsum.photos/seed/i-tx1/600/320', title: 'Income Tax Act 2025: What the "Tax Year" Concept Means for Corporates from April 2026', text: 'The landmark restructuring demands a full enterprise review of tax positions. Higher exemptions and new forms take effect immediately.', readTime: '6 min' },
    { id: 6, link: '/insights/gst-new-structure', category: 'taxation', categoryName: 'Taxation', tagClass: 'bg-green-50 text-green-600', date: 'Mar 2026', img: 'https://picsum.photos/seed/i-tx2/600/320', title: 'GST 2.0: India\'s New Four-Slab Structure and What It Means for Business Cash Flows', text: 'Rationalized slabs, eliminated compensation cess, and hard e-invoice validation are catching businesses unprepared across supply chains.', readTime: '5 min' },
    ...
    { id: 8, link: '/insights/india-ma-2025', category: 'transaction', categoryName: 'Transaction', tagClass: 'bg-purple-50 text-purple-600', date: 'Mar 2026', img: 'https://picsum.photos/seed/i-ta2/600/320', title: 'India M&A 2025: Fewer Deals, 18% Higher Value — Execution Certainty Over Financial Engineering', text: 'Mid-market control deals are dominating. PE is deploying capital with greater discipline, reshaping how advisory mandates are structured.', readTime: '5 min' },
    { id: 9, link: '/insights/mca-accounting-standards', category: 'reporting', categoryName: 'Reporting', tagClass: 'bg-teal-50 text-teal-600', date: 'Apr 2026', img: 'https://picsum.photos/seed/i-fr1/600/320', title: 'MCA\'s Accounting Standards Amendment Rules 2026 — What CFOs Must Act On Immediately', text: 'Revenue recognition, instrument classification, and disclosure changes take effect this quarter. Delayed review risks Q1 restatements.', readTime: '6 min' },
    { id: 10, link: '/insights/brsr-core-assurance', category: 'reporting', categoryName: 'Reporting', tagClass: 'bg-teal-50 text-teal-600', date: 'Feb 2026', img: 'https://picsum.photos/seed/i-fr2/600/320', title: 'BRSR Core Assurance Is Now Mandatory — and SEBI Is Reading What Gets Disclosed', text: 'Third-party assurance on ESG KPIs is no longer optional for India\'s top 1,000 listed companies. Vague disclosures attract exchange scrutiny.', readTime: '5 min' },
    { id: 11, category: 'assurance', categoryName: 'Assurance', tagClass: 'bg-orange-50 text-orange-600', date: 'Apr 2026', img: 'https://picsum.photos/seed/i-ar1/600/320', title: 'From Traditional to Agile: Internal Audit\'s New Mandate in India\'s Regulatory Environment', text: 'Boards demand real-time risk intelligence. Static annual audit plans are giving way to continuous, risk-responsive assurance frameworks.', readTime: '5 min' },
    { id: 12, link: '/insights/dpdp-rules-2025', category: 'assurance', categoryName: 'Assurance', tagClass: 'bg-orange-50 text-orange-600', date: 'Mar 2026', img: 'https://picsum.photos/seed/i-ar2/600/320', title: 'DPDP Rules 2025: Data Privacy Risk Is Now a Board-Level Compliance Obligation', text: 'Penalties of up to ₹250 crore. Consent management obligations. Breach notification windows. A full compliance architecture review is required now.', readTime: '5 min' },
    { id: 13, link: '/insights/tier-2-cities', category: 'consulting', categoryName: 'Consulting', tagClass: 'bg-sky-50 text-sky-600', date: 'Apr 2026', img: 'https://picsum.photos/seed/i-mc1/600/320', title: 'Tier-2 Cities, GCCs, and Supply Chain Resilience — India\'s Three Strategic Growth Vectors', text: 'Overlapping growth opportunities are creating new advisory demand at the intersection of strategy and regulatory execution for Indian enterprises.', readTime: '5 min' },
    { id: 14, link: '/insights/ai-integration-failures', category: 'consulting', categoryName: 'Consulting', tagClass: 'bg-sky-50 text-sky-600', date: 'Feb 2026', img: 'https://picsum.photos/seed/i-mc2/600/320', title: 'AI Integration Failures Trace Back to Governance Design — Not Technology Selection', text: 'Role clarity, data ownership, and change management are the real constraints on AI value realisation in Indian enterprises in 2026.', readTime: '4 min' },
    { id: 15, link: '/insights/csr-impact-evidence', category: 'grants', categoryName: 'Grants & ESG', tagClass: 'bg-green-50 text-green-600', date: 'Apr 2026', img: 'https://picsum.photos/seed/i-gr1/600/320', title: 'CSR 2.0: MCA Now Demands Impact Evidence — Not Just Expenditure Proof', text: 'NGOs without documented outcome metrics are losing renewals. Grant managers must build verified impact frameworks that satisfy MCA\'s evolved expectations.', readTime: '5 min' },
    { id: 16, link: '/insights/fcra-compliance-pmla', category: 'grants', categoryName: 'Grants & ESG', tagClass: 'bg-green-50 text-green-600', date: 'Feb 2026', img: 'https://picsum.photos/seed/i-gr2/600/320', title: 'FCRA Compliance and PMLA Obligations — Why Financial Governance Is Core to NGO Survival', text: 'FCRA renewal rejections are rising sharply. Organisations without audit-ready utilisation documentation risk account freezes and donor loss.', readTime: '5 min' }
  ];
