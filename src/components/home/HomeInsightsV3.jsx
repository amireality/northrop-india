...
const HomeInsightsV3 = () => {
  ...
  const insights = [
    { id: 1, slug: 'india-ma-2025', category: 'due-diligence', categoryName: 'Due Diligence', tagClass: 'bg-blue-50 text-blue-600', date: 'Apr 2026', img: '/reportimg/1ST .png', title: 'India M&A Crosses US$50B — AI Now Cuts FDD Review Time by 50%', text: 'Infrastructure-led deals and AI-enabled diligence tools are reshaping how mid-market acquirers assess risk and valuation.', readTime: '5 min' },
    ...
    { id: 4, slug: 'icai-fais-standards-2025', category: 'forensic', categoryName: 'Forensic', tagClass: 'bg-red-50 text-red-600', date: 'Mar 2026', img: 'reportimg/4TH .png', title: 'ICAI\'s FAIS Standards: 20 Obligations Every Audit Committee Must Now Understand', text: 'From fraud hypothesis to chain-of-custody — FAIS compliance is mandatory for CAs and is redefining forensic governance at board level.', readTime: '6 min' },
    { id: 5, link: '/insights/income-tax-act-2025', category: 'taxation', categoryName: 'Taxation', tagClass: 'bg-green-50 text-green-600', date: 'Apr 2026', img: '/reportimg/5TH .png', title: 'Income Tax Act 2025: What the "Tax Year" Concept Means for Corporates from April 2026', text: 'The landmark restructuring demands a full enterprise review of tax positions. Higher exemptions and new forms take effect immediately.', readTime: '6 min' },
    { id: 6, link: '/insights/gst-new-structure', category: 'taxation', categoryName: 'Taxation', tagClass: 'bg-green-50 text-green-600', date: 'Mar 2026', img: '/reportimg/6TH .png', title: 'GST 2.0: India\'s New Four-Slab Structure and What It Means for Business Cash Flows', text: 'Rationalized slabs, eliminated compensation cess, and hard e-invoice validation are catching businesses unprepared across supply chains.', readTime: '5 min' },
