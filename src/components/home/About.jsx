...
function About() {
  return (
    <section className="bg-[#0b1a31] px-6 py-24 md:px-10 lg:px-20">
      <div className="mx-auto grid w-full max-w-[1400px] gap-16 lg:grid-cols-[1.1fr_1fr] items-center">
        ...
        <div className="relative flex justify-center lg:justify-start">
          ...
          <div className="relative w-full max-w-[550px]">
            <img 
              src="/path-to-your-world-map.png" 
              alt="Global Presence Map" 
              className="w-full opacity-80 brightness-110"
            />
            {/* Optional: Add those orange pins if they are separate assets */}
          </div>
          
          {/* Background Decorative Element (The large 'N' or subtle pattern) */}
          <div className="absolute -left-10 -top-10 -z-10 text-[20rem] font-bold text-white/5 select-none">
            N
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-8">
          <div className="space-y-4">
            <h2 className="text-[44px] font-bold leading-[1.1] text-white tracking-tight">
              About <span className="text-[#c5a044]">Northrop</span>
            </h2>
            
            <div className="h-1 w-20 bg-[#c5a044]"></div> {/* Gold Accent Line */}
          </div>

          <div className="space-y-6">
            {/* Split body content into paragraphs for better readability like the image */}
            <p className="text-[17px] leading-[1.8] text-gray-300 font-light">
          ...
          <div className="pt-4">
            <button className="group flex items-center gap-3 bg-[#e8b021] px-8 py-3 text-[14px] font-bold uppercase tracking-widest text-white transition-all hover:bg-[#d49f1a] rounded-full shadow-lg">
              Read More
