...
import { AnimatePresence, motion } from "framer-motion"; // Changed from "motion/react" to "framer-motion" for compatibility
import { cn } from "../../lib/utils"; // Adjusted path to utils

const SHELL_SPRING = { type: "spring", stiffness: 380, damping: 34 };
...
export const Notch = ({
  ...
  useEffect(() => {
    ...
    function onPointerDown(e) {
      if (!shellRef.current?.contains(e.target)) setOpenItemId(null);
    }
