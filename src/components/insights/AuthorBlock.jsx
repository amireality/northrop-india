    ...
    <div className="mt-16 p-8 bg-white border border-[#c5c6cd] shadow-sm relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start">
        ...
        <div>
          ...
          <h5 className="font-serif text-[22px] font-bold text-[#001F3F] mb-3">Ashish Chaudhary</h5>
          <p className="text-[#45474c] text-[15px] leading-[26px]">
            Ashish Chaudhary is the founder and managing director of Northrop Management Private Limited, a Management Consulting firm with deep roots in forensic accounting and financial advisory based in Delhi NCR.
          </p>
        </div>
      </div>
    </div>
