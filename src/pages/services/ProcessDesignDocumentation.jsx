...
const ProcessDesignDocumentationPage = () => {
  const breadcrumbs = [
    { name: "Home", link: "/" },
    { name: "Services", link: "/services" },
    { name: "Process Design Documentation", link: null }
  ];
      ...
      <section className="relative bg-slate-900 text-white min-h-[70vh] flex items-center pt-24 pb-16 px-6 md:px-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight leading-tight">
            Process <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-teal-400">Design Documentation</span>
          </h1>
...
export default ProcessDesignDocumentationPage;
