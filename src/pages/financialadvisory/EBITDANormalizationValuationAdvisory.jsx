      ...
      <main className="max-w-[1440px] mx-auto">
        ...
        <div className="max-w-[1200px] mx-auto px-[32px] md:px-[24px]">
          ...
          <section className="py-[20px] border-t border-[#000000]/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { cat: "White Paper", title: "The 2026 EBITDA Multiplier Report: Sector Shifts", desc: "How market conditions are redefining what counts as 'sustainable' earnings.", img: "/financialadvisory/ebitda-valuation3.jpeg" },
                { cat: "Strategic Brief", title: "Navigating QofE for Mid-Market Manufacturing", desc: "Key pitfalls in inventory valuation and labor cost capitalization during exit prep.", img: "/financialadvisory/ebitda-valuation4.jpeg" },
                ...
                { cat: "Executive Summary", title: "Defending the Premium: Tech Valuation Anchoring", desc: "Structuring deferred revenue narratives to protect SaaS valuation multiples.", img: "/financialadvisory/ebitda-valuation6.jpeg" }
              ].map((article, idx) => (
