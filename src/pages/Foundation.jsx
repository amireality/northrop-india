...
function Foundation() {
  ...
  return (
    <>
      <section className="relative w-full min-h-screen font-sans bg-[#2a3036] overflow-hidden flex flex-col items-center justify-center">
      ...
      <section className="relative w-full bg-[#f4f3ea] py-[80px] lg:py-[120px] px-[20px] flex justify-center text-[#1c2321]">
        <div className="max-w-[1040px] w-full flex flex-col items-center">
          <div className="flex items-center gap-[12px] mb-[48px]">
            ...
            <span className="text-[11px] font-sans tracking-[0.2em] text-[#c8902a] uppercase font-semibold">The Foundation</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[32px] w-full items-stretch">
            ...
            <div className="bg-white rounded-[16px] p-[40px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden group hover:-translate-y-[4px] transition-transform duration-300">
              ...
              <h3 className="text-[16px] font-sans font-bold text-[#1a1f24] mb-[16px] tracking-wide">Wonder First</h3>
              <p className="text-[12px] font-sans text-[#6b7280] leading-[1.8]">
            ...
            <div className="bg-white rounded-[16px] p-[40px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden group hover:-translate-y-[4px] transition-transform duration-300">
              ...
              <h3 className="text-[16px] font-sans font-bold text-[#1a1f24] mb-[16px] tracking-wide">Rooted in Safety</h3>
              <p className="text-[12px] font-sans text-[#6b7280] leading-[1.8]">
            ...
            <div className="bg-white rounded-[16px] p-[40px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden group hover:-translate-y-[4px] transition-transform duration-300">
              ...
              <h3 className="text-[16px] font-sans font-bold text-[#1a1f24] mb-[16px] tracking-wide">Open Horizons</h3>
              <p className="text-[12px] font-sans text-[#6b7280] leading-[1.8]">
        ...
        <div className="max-w-[1240px] w-full px-[20px] flex justify-center">
          <div className="flex flex-col md:flex-row items-center justify-center divide-y md:divide-y-0 md:divide-x divide-gray-200/80">
            ...
            <div className="flex flex-col items-center text-center px-[40px] lg:px-[60px] py-[32px] md:py-0 w-full md:w-[380px]">
              ...
              <div className="text-[14px] font-sans text-[#2f353b] font-semibold mb-[8px] tracking-[0.02em]">
                India is where we focus
              </div>
              <div className="text-[13px] font-sans text-[#8d96a0] leading-[1.6] max-w-[220px]">
      ...
      <section className="w-full bg-[#fdfaf5] py-[100px] px-[20px] lg:px-[64px] flex justify-center">
        <div className="max-w-[1240px] w-full">
          <div className="flex items-center gap-[14px] mb-[40px]">
            ...
            <span className="text-[10px] font-sans tracking-[0.2em] text-[#c8902a] uppercase font-semibold">What We Bring</span>
          </div>
          ...
          <p className="text-[15px] font-sans text-[#4a4a6a] font-light leading-[1.8] max-w-[500px] mb-[52px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-[24px]">
            ...
            <div className="bg-white rounded-[24px] overflow-hidden shadow-[0_4px_32px_rgba(26,26,46,0.07)] hover:-translate-y-[8px] hover:shadow-[0_12px_48px_rgba(26,26,46,0.12)] transition-all duration-400 group">
              ...
              <div className="p-[32px] pt-[28px] bg-white">
                ...
                <p className="text-[13px] font-sans font-light text-[#4a4a6a] leading-[1.85]">Art, science, sport, music, nature, a story well told. Learning is part of it. It is not all of it.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[24px] overflow-hidden shadow-[0_4px_32px_rgba(26,26,46,0.07)] hover:-translate-y-[8px] hover:shadow-[0_12px_48px_rgba(26,26,46,0.12)] transition-all duration-400 group">
              ...
              <div className="p-[32px] pt-[28px] bg-white">
                ...
                <p className="text-[13px] font-sans font-light text-[#4a4a6a] leading-[1.85]">We back programs that bring stability and the consistent presence that lets a child exhale and simply be young.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[24px] overflow-hidden shadow-[0_4px_32px_rgba(26,26,46,0.07)] hover:-translate-y-[8px] hover:shadow-[0_12px_48px_rgba(26,26,46,0.12)] transition-all duration-400 group">
              ...
              <div className="p-[32px] pt-[28px] bg-white">
                ...
                <p className="text-[13px] font-sans font-light text-[#4a4a6a] leading-[1.85]">When a child believes their future is open — that belief is what we are here to plant, water, and protect.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="manifesto" className="relative w-full bg-gradient-to-br from-[#fff8ee] via-[#fff3d6] to-[#f0f7ff] py-[120px] px-[20px] lg:px-[64px] flex justify-center overflow-hidden z-10">
        ...
        <div className="max-w-[860px] w-full relative z-10">
          <div className="flex items-center gap-[14px] mb-[52px]">
            ...
            <span className="text-[10px] font-sans tracking-[0.22em] text-[#c8902a] uppercase font-semibold">Our Manifesto</span>
          </div>
      ...
      <section className="w-full bg-white py-[100px] px-[20px] lg:px-[64px] flex justify-center">
        <div className="max-w-[1240px] w-full grid grid-cols-1 lg:grid-cols-2 gap-[80px] items-center">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-[14px] mb-[40px]">
              <div className="w-[28px] h-[1px] bg-[#c8902a]"></div>
              <span className="text-[10px] font-sans tracking-[0.2em] text-[#c8902a] uppercase font-semibold">Why We Exist</span>
            </div>
            <h2 className="text-[32px] md:text-[50px] font-serif leading-[1.1] text-[#1a1a2e] mb-[14px] tracking-[-0.02em]">
              We do not wait for <em className="text-[#c8902a] italic">rescue stories</em>
            </h2>
            <p className="text-[15px] font-sans text-[#4a4a6a] font-light leading-[1.8] max-w-[480px] mb-[36px]">
        ...
        <div className="max-w-[1240px] w-full flex flex-col items-center">
          <div className="text-center max-w-[620px] mb-[60px] flex flex-col items-center">
            <div className="flex items-center gap-[14px] mb-[40px] justify-center mx-auto">
              <div className="w-[28px] h-[1px] bg-[#c8902a]"></div>
              <span className="text-[10px] font-sans tracking-[0.2em] text-[#c8902a] uppercase font-semibold">A Shared Commitment</span>
            </div>
            ...
            <p className="text-[15px] font-sans text-[#4a4a6a] font-light leading-[1.8] max-w-[500px] text-center">
        ...
        <div className="max-w-[1240px] w-full flex flex-col">
          <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-[40px] mb-[56px]">
            <div>
              <div className="flex items-center gap-[14px] mb-[40px]">
                <div className="w-[28px] h-[1px] bg-[#c8902a]"></div>
                <span className="text-[10px] font-sans tracking-[0.2em] text-[#c8902a] uppercase font-semibold">Who Can Join</span>
              </div>
        ...
        <div className="max-w-[1240px] w-full grid grid-cols-1 lg:grid-cols-2 gap-[80px] items-start">
          ...
          <div>
            <div className="flex items-center gap-[14px] mb-[28px]">
              <div className="w-[24px] h-[1px] bg-[#c8902a]"></div>
              <span className="text-[10px] font-sans tracking-[0.22em] text-[#c8902a] uppercase font-semibold">Join Hands</span>
            </div>
            ...
            <p className="text-[15px] font-sans text-[#4a4a6a] font-light leading-[1.9] mb-[40px]">
            ...
            <form className="flex flex-col w-full" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-[12px] mb-[16px]">
                <div className="flex flex-col">
                  ...
                  <input type="text" placeholder="First name" className="w-full p-[12px_16px] bg-[#fdfaf5] border-2 border-[rgba(26,26,46,0.08)] text-[#1a1a2e] font-sans text-[14px] font-light rounded-[10px] outline-none transition-all duration-300 placeholder:text-[#9090b0] focus:border-[#c8902a] focus:bg-[#fff3d6]"/>
                </div>
                <div className="flex flex-col">
                  <label className="text-[10px] tracking-[0.12em] uppercase text-[#9090b0] font-semibold mb-[7px]">Last Name</label>
                  <input type="text" placeholder="Last name" className="w-full p-[12px_16px] bg-[#fdfaf5] border-2 border-[rgba(26,26,46,0.08)] text-[#1a1a2e] font-sans text-[14px] font-light rounded-[10px] outline-none transition-all duration-300 placeholder:text-[#9090b0] focus:border-[#c8902a] focus:bg-[#fff3d6]"/>
                </div>
              </div>

              <div className="flex flex-col mb-[16px]">
                <label className="text-[10px] tracking-[0.12em] uppercase text-[#9090b0] font-semibold mb-[7px]">Organisation</label>
                <input type="text" placeholder="Company, institution, or individual" className="w-full p-[12px_16px] bg-[#fdfaf5] border-2 border-[rgba(26,26,46,0.08)] text-[#1a1a2e] font-sans text-[14px] font-light rounded-[10px] outline-none transition-all duration-300 placeholder:text-[#9090b0] focus:border-[#c8902a] focus:bg-[#fff3d6]"/>
              </div>

              <div className="flex flex-col mb-[16px]">
                <label className="text-[10px] tracking-[0.12em] uppercase text-[#9090b0] font-semibold mb-[7px]">Email</label>
                <input type="email" placeholder="your@email.com" className="w-full p-[12px_16px] bg-[#fdfaf5] border-2 border-[rgba(26,26,46,0.08)] text-[#1a1a2e] font-sans text-[14px] font-light rounded-[10px] outline-none transition-all duration-300 placeholder:text-[#9090b0] focus:border-[#c8902a] focus:bg-[#fff3d6]"/>
              </div>

              <div className="flex flex-col mb-[16px]">
                <label className="text-[10px] tracking-[0.12em] uppercase text-[#9090b0] font-semibold mb-[7px]">How would you like to engage?</label>
                <select className="w-full p-[12px_16px] bg-[#fdfaf5] border-2 border-[rgba(26,26,46,0.08)] text-[#1a1a2e] font-sans text-[14px] font-light rounded-[10px] outline-none transition-all duration-300 appearance-none focus:border-[#c8902a] focus:bg-[#fff3d6] bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%239090B0%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E')] bg-no-repeat bg-[right_16px_top_50%] bg-[length:10px_auto] cursor-pointer">
              ...
              <div className="flex flex-col mb-[16px]">
                ...
                <textarea placeholder="Tell us about yourself and why this matters to you..." className="w-full h-[86px] resize-y p-[12px_16px] bg-[#fdfaf5] border-2 border-[rgba(26,26,46,0.08)] text-[#1a1a2e] font-sans text-[14px] font-light rounded-[10px] outline-none transition-all duration-300 placeholder:text-[#9090b0] focus:border-[#c8902a] focus:bg-[#fff3d6]"></textarea>
              </div>

              <button className="w-full p-[15px] mt-[8px] bg-[#1a1a2e] text-white font-sans text-[11px] font-bold tracking-[0.14em] uppercase rounded-[10px] transition-all duration-300 hover:bg-[#c8902a] hover:shadow-[0_8px_32px_rgba(200,144,42,0.3)] hover:-translate-y-[2px]">
                Send Message
              </button>
            </form>
          </div>
